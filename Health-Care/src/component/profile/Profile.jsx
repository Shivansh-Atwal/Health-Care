...
function Profile() {
  ...
  useEffect(() => {
    const fetchUserDetails = async () => {
      ...
      try {
        const res = await fetch(`${import.meta.env.VITE_URL}auth/me`, {
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <div className="space-y-3">
                ...
                <Link to="/dashboard" className="w-full bg-gray-600 text-white py-3 px-4 rounded-lg hover:bg-gray-700 transition-colors flex items-center justify-center">
