...
const ReportForm = ({ appointment, onClose, onReportSaved }) => {
  ...
  const checkExistingReport = async () => {
    try {
      const response = await fetch(`${import.meta.env.VITE_URL}reports/appointment/${appointment._id}`, {
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = isEditing 
        ? `${import.meta.env.VITE_URL}reports/${existingReport._id}`
        : `${import.meta.env.VITE_URL}reports/create`;
